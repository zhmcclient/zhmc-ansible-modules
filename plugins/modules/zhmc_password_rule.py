...
options:
  ...
  state:
    description:
      ...
      - "* V(absent): Ensures that the password rule does not exist."
      - "* V(present): Ensures that the password rule exists and has the
         specified properties."
      - "* V(facts): Returns the password rule properties."
    type: str
    required: true
  ...
  properties:
    description:
      ...
      - "Properties omitted in this dictionary will remain unchanged when the
         ...
         in the data model for password rules in the R(HMC API,HMC API) book
         when the password rule is being created."
    type: dict
    required: false
    default: null
  log_file:
  ...
  contains:
    ...
    "{property}":
      description: "Additional properties of the password rule, as described
        in the data model of the 'Password Rule' object in the R(HMC API,HMC API)

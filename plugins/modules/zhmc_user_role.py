...
options:
  ...
  state:
    description:
      ...
      - "* V(absent): Ensures that the user role does not exist."
      - "* V(present): Ensures that the user role exists and has the
         specified properties."
      - "* V(facts): Returns the user role properties."
    type: str
    required: true
  ...
  properties:
    description:
      ...
      - "Properties omitted in this dictionary will remain unchanged when the
         ...
         in the data model for user roles in the R(HMC API,HMC API) book when
         the user role is being created."
    type: dict
    required: false
    default: null
    suboptions:
      ...
      associated_system_defined_user_role_name:
        description:
          ...
          - "Optional, default: V(hmc-operator-tasks)."
        type: str
        required: false
      permissions:
        description:
          ...
          class:
            description:
              - "Permission item: Object permission to all objects of the
                specified resource class (= value of C(class) property)."
            type: str
          group:
            description:
  ...
  contains:
    ...
    "{property}":
      description: "Additional properties of the user role, as described
        in the data model of the 'User Role' object in the R(HMC API,HMC API)

...
from ansible.modules.zhmc import zhmc_virtual_function
...
class TestZhmcVirtualFunctionMain(object):
    ...
    @mock.patch("ansible.modules.zhmc.zhmc_virtual_function.perform_task",
                autospec=True)
    @mock.patch("ansible.modules.zhmc.zhmc_virtual_function.AnsibleModule",
                autospec=True)
...
class TestZhmcVirtualFunctionPerformTask(object):
    ...
    @pytest.mark.parametrize(
        "check_mode", [False, True])
    @mock.patch("ansible.modules.zhmc.zhmc_virtual_function.ensure_absent",
                autospec=True)
    @mock.patch("ansible.modules.zhmc.zhmc_virtual_function.ensure_present",
                autospec=True)
    def test_pt_present(

...
.. raw:: html
    ...
    <td></td>
    <td>
        <div>Dictionary with input properties for the NIC, for <code>state=present</code>. Key is the property name with underscores instead of hyphens, and value is the property value in YAML syntax. Will be ignored for <code>state=absent</code>.</div>

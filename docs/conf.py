...
extensions = [
    ...
    # 'sphinx.ext.todo',
    # 'sphinx.ext.coverage',
    # 'sphinx.ext.viewcode',   # disabled, raises an exception
    # 'sphinx.ext.ifconfig',
...
project = u'zhmc Ansible modules'
copyright = u'IBM'
...
version = package_version('zhmc_ansible_modules')
...
exclude_patterns = ["tests", ".tox", ".git", "attic",
                    "build", "zhmc_ansible_modules.egg-info", ".eggs"]
...
extlinks = {
    'nbview': ('http://nbviewer.jupyter.org/github/'
               'zhmcclient/python-zhmcclient'
               '/blob/master/docs/notebooks/%s', ''),
    'nbdown': ('https://github.com/zhmcclient/python-zhmcclient/raw/master'
               '/docs/notebooks/%s', '')
}

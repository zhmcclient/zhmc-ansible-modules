...
Python environment and instead of installing from Ansible Galaxy (step 5),
perform these steps:

5a. Clone the repo and checkout the desired branch:
...
5b. Build and install the collection:
